...
class Comedy(webapp2.RequestHandler):
    def get(self):
        ...
        comedy_movies_title = ['Shutter Island','Inception','Memento','Zodiac','Se7en']
        comedy_movies_director = ['Martin Scorsese', 'Christopher Nolan', 'Christopher Nolan', 'David Fincher', 'David Fincher']
...
class Drama(webapp2.RequestHandler):
    def get(self):
        ...
        drama_movies_title = ['Shutter Island','Inception','Memento','Zodiac','Se7en']
        drama_movies_director = ['Martin Scorsese', 'Christopher Nolan', 'Christopher Nolan', 'David Fincher', 'David Fincher']
...
class Horror(webapp2.RequestHandler):
    def get(self):
        ...
        horror_movies_title = ['Shutter Island','Inception','Memento','Zodiac','Se7en']
        horror_movies_director = ['Martin Scorsese', 'Christopher Nolan', 'Christopher Nolan', 'David Fincher', 'David Fincher']
